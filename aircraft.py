...
class Aircraft:
    ...
    def init_structure(self, **kwargs):
        self.structure = Structure(self.case_name, self.case_route, self.source_directory, **kwargs)

    def init_aero(self, m, **kwargs):
        self.aero = Aero(m, self.structure, self.case_name, self.case_route, self.source_directory,**kwargs)

    def init_fuselage(self, m, **kwargs):
        self.fuselage = Fuselage(m, self.structure, self.case_name, self.case_route, self.source_directory, **kwargs)
